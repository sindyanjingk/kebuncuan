...
import { User, MapPin, CreditCard, Eye, EyeOff, ShoppingBag } from 'lucide-react'
...
interface CustomerProfileClientProps {
  // storeSlug tidak lagi diperlukan karena profile universal
}

export function CustomerProfileClient(_props?: CustomerProfileClientProps) {
                  ...
                  <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Upload foto profile baru</p>
                ...
                <CardContent>
                  {ordersLoading ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-gray-400 mt-2">Pesanan Anda akan muncul di sini</p>
                    </div>
                  ) : (
                          ...
                          <div className="flex justify-between items-start mb-3">
                            <div>
                              ...
                              <p className="text-sm text-gray-500">
                                {order.product.store?.name} • {order.product.category?.name}
                              </p>
                            </div>
                          ...
                          {order.shipping.required && (
                            <div className="mt-3 pt-3 border-t">
                              ...
                              <p className="text-sm text-gray-600">
                                {order.shipping.address}, {order.shipping.city}, {order.shipping.province} {order.shipping.postal_code}
                              </p>
